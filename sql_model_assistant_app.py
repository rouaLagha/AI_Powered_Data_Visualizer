...
def _init_state() -> None:
    ...
    st.session_state.setdefault(
        ...
        str(DEFAULT_LLM_CONFIG if DEFAULT_LLM_CONFIG.exists() else FALLBACK_LLM_CONFIG),
    )
...
def _load_optional_llm(llm_config_path: str):
    candidates = []
    if llm_config_path:
        candidates.append(Path(llm_config_path))
    candidates.extend([DEFAULT_LLM_CONFIG, FALLBACK_LLM_CONFIG])
